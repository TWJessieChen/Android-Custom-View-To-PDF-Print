...
//        baselineCount++
    ...
    fun setMaxValue(max_value: Int): StaticEcgBackgroundView {
...
//    }
    ...
    fun setWaveLineColor(colorString: String?): StaticEcgBackgroundView {
        waveLineColor = Color.parseColor(colorString)
        return this
    }

    fun setGridVisible(visible: Boolean): StaticEcgBackgroundView {
        gridVisible = visible
        return this
    }

    fun setGridLineColor(colorString: String?): StaticEcgBackgroundView {
        gridLineColor = Color.parseColor(colorString)
        return this
    }

    fun setWaveBackground(colorString: String?): StaticEcgBackgroundView {
        setBackgroundColor(Color.parseColor(colorString))
        return this
    }

    fun setWaveDrawMode(draw_mode: Int): StaticEcgBackgroundView {
        drawMode = draw_mode
        return this
    }
