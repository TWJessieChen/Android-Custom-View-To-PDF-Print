 ...
 * @describe TODO
 */
public class StaticECGBackgroundRenderer {
    ...
    private StaticECGSoftStrategy mSoftStrategy = null;
    ...
    public StaticECGBackgroundRenderer(@NonNull Context context, @NonNull StaticECGSoftStrategy softStrategy,@NonNull int type, String leadName, int gain) {
